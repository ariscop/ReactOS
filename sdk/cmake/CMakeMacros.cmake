...
function(add_pch _target _pch)
    if(NOT TARGET ${_target})
        message(SEND_ERROR "No such target ${_target}")
    endif()
    get_filename_component(_pch "${_pch}" ABSOLUTE)
    if(NOT EXISTS ${_pch})
        message(SEND_ERROR "No such file ${_pch}")
    endif()
    if(ARGN)
        message(SEND_ERROR "Unexpected arguments: ${ARGN}")
    endif()
endfunction()
